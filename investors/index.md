...
*Source: <https://sgit.ai/investors/index.html> · site v0.6.6 · this file is generated from the same content as the page, so the two cannot drift. Every page on this site has a `.md` twin; internal links below point at them.*
...
164**site releases since 14 August**
each verified live before it was called done

35**vaults published with a public read key**
