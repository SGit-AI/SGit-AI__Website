...
| **Evidence, not pitch** | Every claim about what we can do points at a vault that can be opened with a read key, a measurement with its command printed, or a page that states its own limits. The [thirty-one published vaults](../demos/vaults/index.md) are the portfolio. |
