...
> UK Sovereign AI names trust, safety and assurance as one of five frontiers and the safe adoption of AI agents as a procurement challenge area. This page states their mission in their own words, maps each priority to vaults published here that can be opened now (Licence to Operate, Risk Mandate, AIUC-1 conformance, the DSIT AI Risk Toolkit, Regulation Graph), proposes three concrete partnership shapes sized to their instruments, and lists what the page cannot tell them. Public material only.

*Source: <https://sgit.ai/partnerships/sovereign-ai.html> · site v0.5.7 · this file is generated from the same content as the page, so the two cannot drift. Every page on this site has a `.md` twin; internal links below point at them.*
...
- **Anchoring and corporate structure.** The fund's central test is a significant and enduring UK presence. The public record on this site does not state the companies' domicile, headquarters or team location, and this page will not assert them. That is a conversation, and the fund's own [contact form](https://www.sovereignai.gov.uk/about) or [the author's](../about/index.md) are the routes to it.
