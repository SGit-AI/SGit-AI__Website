...
New page: [**Reading one file out of a vault**](/vault/reading-a-vault-file.html), which is the primitive underneath every live embed on this site, written down on its own for the first time, with the sandbox rules for what comes back.
