...
Two days ago v0.2.55 published a [build brief](/docs/briefs/vault-telemetry-append-lanes.html) on getting telemetry out of a vault whose read key is public. An agent [built a vault from it](/demos/vaults/agent-permission-games/index.html) and could not get events out. The SG/API team read the append-lane code against our page and returned a line-referenced review.
