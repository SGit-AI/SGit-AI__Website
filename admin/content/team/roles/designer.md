...
checks: no horizontal overflow at 390 wide; no static img src or script src (the validator refuses both); every generated component carries hidden text separators so its .md twin reads as prose; a screenshot of the change exists
---
## What the role does
