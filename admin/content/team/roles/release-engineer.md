...
checks: SITE_VERSION matches the commit subject; validate passes including the leak tripwire; sgit and git both report in sync; the live site serves the new version before the release is reported; nothing dirty after except .sg_vault/bare/refs
---
## What the role does
