...
!shot before-hero.webp | images/ | The hero today: a claim about encryption, a pip install, and a terminal walkthrough of create, commit, history and clone.
...
!shot before-usecases.webp | images/ | Five use-case cards, each a category rather than a thing: private memory, multi-agent collaboration, workspaces, encrypted folders, signed exchange.
...
!shot before-nav.webp | images/ | Vaults → Published vaults. Two clicks from the hero to the most persuasive page on the site.

And when you get there, it is a table:

!shot before-vaults-table.webp | images/ | The published vaults, as of this week: sortable, categorised, and still a table — the right shape for finding a vault, the wrong shape for being convinced by one.
...
!shot proof-insurability.webp | images/ | A real vault, open: the AIUC-1 conformance layer computing insurability for a named subject as of a date — one condition met, 52 exclusions, zero of five consequences covered, each with the reason in the control's own words.

!shot proof-game.webp | images/ | Another: a game about which wings of the building an agent can enter, drawn as a floor plan, with a belief column ranking nine public agent profiles as you answer.
...
!shot before-briefs.webp | images/ | The briefs page — the cross-team collaboration log — filed under Docs, three levels from the homepage, and written as a log rather than a story.
...
!site open-source.sgit.ai | /about/index.html | About the author — Dinis Cruz | The record across four companies, built in the open including the parts most companies keep closed, and the interests declared.
