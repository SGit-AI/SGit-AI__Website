...
date: 2026-08-25
summary: An introduction to sgit and sgit.ai — what an encrypted vault is, why version control had to be rebuilt to get one, and what eleven published vaults look like when the server storing them cannot read a byte.
version: v0.2.42
...
## Eleven vaults you can open right now
...
They range from a photo library to Regulation (EU) 2024/1689 parsed from official Formex XML into 1,523 nodes and 1,944 edges. Before writing this I cloned all eleven from their published keys: **781 files, no failures.**
...
!shot site-network.webp | images/ | Four sites so far. More are coming.

- [**graphs.sgit.ai**](/network/graphs.html) — a grammar for semantic graphs. *"A node is just a node. Meaning lives in the edges."*
- [**nhi.sgit.ai**](/network/nhi.html) — identity for non-human actors: agents you run versus agents you rent.
- [**pki.sgit.ai**](/network/pki.html) — key distribution, with four registry rules published before the registry.
