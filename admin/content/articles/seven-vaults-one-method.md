...
Between 14 and 18 August this site published seven vaults. Each one is a real encrypted vault you can open in a browser from a read key printed on its page: [a photo gallery](/demos/vaults/algarve-may-2026/index.html), [field notes](/demos/vaults/field-notes/index.html), [a patient-held supplement record](/demos/vaults/supplement-stack/index.html), [a risk register](/demos/vaults/risk-mandate/index.html), [a browser-isolation risk graph](/demos/vaults/agentic-browser-isolation/index.html), [a fact-to-risk explorer](/demos/vaults/risk-graph-explorer/index.html), and [the catalogue that indexes them](/catalogue/index.html) — itself a vault.
...
They were caught by shape. A read key is 64 hex characters; a vault key is a generated passphrase, which is 24 lowercase alphanumerics. That catch depended on somebody looking, which is not a control. So it became [a script](/demos/vaults/publishing.html):
...
This is the part that is tempting to skip and never should be. A published vault is an argument that this way of working is sound; an argument that omits its own edges is a brochure. The [limitations page](/docs/limitations.html) is the same instinct at site level, and the [comparison pages](/compare/index.html) go further still — they include rows where vaults lose.

## What it cost, and what it bought

Seven vaults, roughly four days of work, and the method is now [written down as a playbook](/demos/vaults/publishing.html) aimed at another site's agent rather than at us — which was the real test of whether it was a method or just a habit.
